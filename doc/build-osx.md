...
1. Clone the VPS Core source code:

        git clone https://github.com/vipo-project/vipo
        cd vipo
...
VPS Core is now available at `./src/vipod`

Before running, you may create an empty configuration file:

    mkdir -p "/Users/${USER}/Library/Application Support/VPS"

    touch "/Users/${USER}/Library/Application Support/VPS/vipo.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/VPS/vipo.conf"

The first time you run vipod, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.

You can monitor the download process by looking at the debug.log file:

    tail -f $HOME/Library/Application\ Support/VPS/debug.log

Other commands:
-------

    ./src/vipod -daemon # Starts the vipo daemon.
    ./src/vipo-cli --help # Outputs a list of command-line options.
    ./src/vipo-cli help # Outputs a list of RPC commands when the daemon is running.
