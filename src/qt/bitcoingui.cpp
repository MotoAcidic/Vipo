...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and vipo: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Vipo"), this);
    aboutAction->setStatusTip(tr("Show information about Vipo"));
    ...
    openAction->setStatusTip(tr("Open a VPS: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Vipo help message to get a list with possible VPS command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Vipo client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("Vipo"); // default title
