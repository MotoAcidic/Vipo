...
// Wallet
    ...
    if (settings.contains("nAnonymizeVipoAmount"))
        SoftSetArg("-anonymizevipoamount", settings.value("nAnonymizeVipoAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in vipo.cpp during shotdown to also remove the window positions
