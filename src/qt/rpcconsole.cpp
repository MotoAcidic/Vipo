                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzVPSPathCustom = GetArg("-zpivbackuppath", "");
    ...
    if(!strzVPSPathCustom.empty()) {
        ui->wallet_customzpivbackuppath->setText(QString::fromStdString(strzVPSPathCustom));
        ui->wallet_customzpivbackuppath_label->setVisible(true);
        ui->wallet_customzpivbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzVPSPathCustom.empty()) && nCustomBackupThreshold > 0) {
