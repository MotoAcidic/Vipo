...
#define SPORK_18_PAYMENT_RECIPIENT_ENFORCEMENT 10017
...
#define SPORK_18_PAYMENT_ENFORCEMENT_DEFAULT 4070908800   //OFF  
...
public:
    ...
    uint256 GetHash()
    {
        uint256 n = lyra2rev3_hash(BEGIN(nSporkID), END(nTimeSigned));
        return n;
    }
