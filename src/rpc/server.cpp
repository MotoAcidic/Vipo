...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Vipo features */
        {"vipo", "listmasternodes", &listmasternodes, true, true, false},
        {"vipo", "getmasternodecount", &getmasternodecount, true, true, false},
        {"vipo", "masternodeconnect", &masternodeconnect, true, true, false},
        {"vipo", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"vipo", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"vipo", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"vipo", "masternodecurrent", &masternodecurrent, true, true, false},
        {"vipo", "masternodedebug", &masternodedebug, true, true, false},
        {"vipo", "startmasternode", &startmasternode, true, true, false},
        {"vipo", "createmasternodekey", &createmasternodekey, true, true, false},
        {"vipo", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"vipo", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"vipo", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"vipo", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"vipo", "getmasternodescores", &getmasternodescores, true, true, false},
        {"vipo", "preparebudget", &preparebudget, true, true, false},
        {"vipo", "submitbudget", &submitbudget, true, true, false},
        {"vipo", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"vipo", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"vipo", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"vipo", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"vipo", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"vipo", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"vipo", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"vipo", "checkbudgets", &checkbudgets, true, true, false},
        {"vipo", "mnsync", &mnsync, true, true, false},
        {"vipo", "spork", &spork, true, true, false},
        {"vipo", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> vipo-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:58322/\n";
}
