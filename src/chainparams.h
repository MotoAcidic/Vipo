...
public:
    ...
    int VipoBadBlockTime() const { return nVipoBadBlockTime; }
    int VipoBadBlocknBits() const { return nVipoBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t nVipoBadBlockTime;
    unsigned int nVipoBadBlocknBits;
