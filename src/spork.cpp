...
// VPS: on startup load spork values from previous session if they exist in the sporkDB
...
int64_t GetSporkValue(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID)) {
        ...
        if (nSporkID == SPORK_18_PAYMENT_RECIPIENT_ENFORCEMENT) r = SPORK_18_PAYMENT_ENFORCEMENT_DEFAULT;
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_18_PAYMENT_RECIPIENT_ENFORCEMENT") return SPORK_18_PAYMENT_RECIPIENT_ENFORCEMENT;
...
std::string CSporkManager::GetSporkNameByID(int id)
{
    ...
    if (id == SPORK_18_PAYMENT_RECIPIENT_ENFORCEMENT) return "SPORK_18_PAYMENT_RECIPIENT_ENFORCEMENT";
