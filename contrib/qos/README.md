...
This means one can have an always-on vipod instance running, and another local vipod/vipo-qt instance which connects to this node and receives blocks from it.
