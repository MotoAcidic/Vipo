...
RESOURCES += src/qt/vipo.qrc src/qt/vipo_locale.qrc

TRANSLATIONS += src/qt/locale/vipo_bg.ts \
                src/qt/locale/vipo_de.ts \
                src/qt/locale/vipo_en.ts \
                src/qt/locale/vipo_es.ts \
                src/qt/locale/vipo_fi.ts \
                src/qt/locale/vipo_fr.ts \
                src/qt/locale/vipo_it.ts \
                src/qt/locale/vipo_ja.ts \
                src/qt/locale/vipo_pl.ts \
                src/qt/locale/vipo_pt.ts \
                src/qt/locale/vipo_ru.ts \
                src/qt/locale/vipo_sk.ts \
                src/qt/locale/vipo_sv.ts \
                src/qt/locale/vipo_vi.ts \
                src/qt/locale/vipo_zh_CN.ts \
                src/qt/locale/vipo_zh_TW.ts
