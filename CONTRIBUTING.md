Contributing to VPS Core
============================

The VPS Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/vipo-project/vipo/blob/master/doc/translation_process.md)
...
The following applies to code changes to the VPS Core project, and is not to be
confused with overall VPS Network Protocol consensus changes.

Whether a pull request is merged into VPS Core rests with the project merge
...
Patches that change VPS consensus rules are considerably more involved than
...
Where a patchset proposes to change the VPS consensus, it must have been
...
The project leader is the release manager for each VPS Core release.
